...
module.exports = ({wallets, startIndex, value, dataHook, onChangeWallet, children}) => {
    return <Slider startIndex={startIndex} dataHook={dataHook} onChangeSlide={onChangeWallet} rightPan={children}>{
